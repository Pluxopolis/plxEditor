		...
		if (cmd == "link" && !value) {
			...
			if(url!==null) {
				...
				if (match) if (match.length >= 2) {
					var videoId = match[2];
					var s = '<div class="frame"><iframe style="border:0;max-width:560px" src="https://www.youtube.com/embed/'+videoId+'" width="560" height="315" allowfullscreen></iframe></youtube>';
